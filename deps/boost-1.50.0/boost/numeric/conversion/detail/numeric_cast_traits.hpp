...
namespace riakboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(riakboost::long_long_type)(riakboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (riakboost::long_long_type)(riakboost::ulong_long_type)
