...
#include <boost/cstdint.hpp> // for riakboost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         riakboost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    riakboost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  riakboost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  riakboost::non_type<t, v>*
...
#define BOOST_MATH_STD_USING \
   ...
   using std::log10;\
   using std::sqrt;\
   using riakboost::math::round;\
   using riakboost::math::iround;\
   using riakboost::math::lround;\
   using riakboost::math::trunc;\
   using riakboost::math::itrunc;\
   using riakboost::math::ltrunc;\
   using riakboost::math::modf;
...
#    define BOOST_FPU_EXCEPTION_GUARD riakboost::math::detail::fpu_guard local_guard_object;
