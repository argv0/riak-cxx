...
//
// This must not be located in any namespace under riakboost::math
...
template <class T>
inline bool is_nan_helper(T t, const riakboost::true_type&)
{
#ifdef isnan
   return isnan(t);
...
template <class T>
inline bool is_nan_helper(T, const riakboost::false_type&)
{
   return false;
}
...
inline int fpclassify_imp BOOST_NO_MACRO_EXPAND(T t, const generic_tag<true>&)
{
   ...
   if(::riakboost::math_detail::is_nan_helper(t, ::riakboost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(isnan)
   if(riakboost::math_detail::is_nan_helper(t, ::riakboost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(_MSC_VER) || defined(__BORLANDC__)
   if(::_isnan(riakboost::math::tools::real_cast<double>(t)))
      return FP_NAN;
#endif
...
{
   return riakboost::math::detail::fpclassify_imp(t, generic_tag<true>());
}
#endif
...
{
   return riakboost::math::detail::isfinite_impl(t, generic_tag<true>());
}
#endif
...
{ //!< \brief return true if floating-point type t is finite.
   typedef typename detail::fp_traits<T>::type traits;
   typedef typename traits::method method;
   typedef typename riakboost::is_floating_point<T>::type fp_tag;
...
{
   return riakboost::math::detail::isnormal_impl(t, generic_tag<true>());
}
#endif
...
{
   return riakboost::math::detail::isinf_impl(t, generic_tag<true>());
}
#endif
...
#ifdef isnan
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<float>(float t){ return ::riakboost::math_detail::is_nan_helper(t, riakboost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<double>(double t){ return ::riakboost::math_detail::is_nan_helper(t, riakboost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<long double>(long double t){ return ::riakboost::math_detail::is_nan_helper(t, riakboost::true_type()); }
#endif
