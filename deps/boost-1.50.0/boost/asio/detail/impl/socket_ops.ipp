    ...
    std::size_t addrlen, riakboost::system::error_code& ec)
{
  ...
  else if (ec == riakboost::asio::error::try_again)
    ec = riakboost::asio::error::no_buffer_space;
...
int poll_read(socket_type s, state_type state, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
  ...
  if (result == 0)
    ec = (state & user_set_non_blocking)
      ? riakboost::asio::error::would_block : riakboost::system::error_code();
  else if (result > 0)
    ec = riakboost::system::error_code();
  return result;
}

int poll_write(socket_type s, state_type state, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
