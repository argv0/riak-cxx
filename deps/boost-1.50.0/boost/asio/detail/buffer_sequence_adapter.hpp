...
class buffer_sequence_adapter<Buffer, riakboost::array<Elem, 2> >
  : buffer_sequence_adapter_base
{
public:
  explicit buffer_sequence_adapter(
      const riakboost::array<Elem, 2>& buffer_sequence)
  {
    init_native_buffer(buffers_[0], Buffer(buffer_sequence[0]));
    init_native_buffer(buffers_[1], Buffer(buffer_sequence[1]));
    total_buffer_size_ = riakboost::asio::buffer_size(buffer_sequence[0])
      + riakboost::asio::buffer_size(buffer_sequence[1]);
  }
  ...
  static bool all_empty(const riakboost::array<Elem, 2>& buffer_sequence)
  {
    return riakboost::asio::buffer_size(buffer_sequence[0]) == 0
      && riakboost::asio::buffer_size(buffer_sequence[1]) == 0;
  }

  static void validate(const riakboost::array<Elem, 2>& buffer_sequence)
  {
    riakboost::asio::buffer_cast<const void*>(buffer_sequence[0]);
    riakboost::asio::buffer_cast<const void*>(buffer_sequence[1]);
  }

  static Buffer first(const riakboost::array<Elem, 2>& buffer_sequence)
  {
    return Buffer(riakboost::asio::buffer_size(buffer_sequence[0]) != 0
