...
namespace detail
{
  ...
  template <typename AsyncWriteStream, typename Elem,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, riakboost::array<Elem, 2>,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_op(AsyncWriteStream& stream, const riakboost::array<Elem, 2>& buffers,
        CompletionCondition completion_condition, WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        stream_(stream),
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      typename riakboost::asio::detail::dependent_type<Elem,
          riakboost::array<riakboost::asio::const_buffer, 2> >::type bufs = {{
        riakboost::asio::const_buffer(buffers_[0]),
        riakboost::asio::const_buffer(buffers_[1]) }};
  ...
  public:
    ...
    {
      typename riakboost::asio::detail::dependent_type<Elem,
          std::array<riakboost::asio::const_buffer, 2> >::type bufs = {{
        riakboost::asio::const_buffer(buffers_[0]),
        riakboost::asio::const_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = riakboost::asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = riakboost::asio::buffer_size(bufs[1]);
