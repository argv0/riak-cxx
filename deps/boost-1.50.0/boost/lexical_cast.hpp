...
#       warning "Unable to use <locale> header. riakboost::lexical_cast will use the 'C' locale."
...
namespace riakboost {
    ...
    namespace detail // is_char_or_wchar<...> and stream_char<...> templates
    {
        ...
        {
            typedef ::riakboost::type_traits::ice_or<
                    ::riakboost::is_same< T, char >::value,
                    #ifndef BOOST_LCAST_NO_WCHAR_T
                        ::riakboost::is_same< T, wchar_t >::value,
                    #endif
                    #ifndef BOOST_NO_CHAR16_T
                        ::riakboost::is_same< T, char16_t >::value,
                    #endif
                    #ifndef BOOST_NO_CHAR32_T
                        ::riakboost::is_same< T, char32_t >::value,
                    #endif
                    ::riakboost::is_same< T, unsigned char >::value,
                    ::riakboost::is_same< T, signed char >::value
            > result_type;
        ...
        struct stream_char
        {
            typedef BOOST_DEDUCED_TYPENAME riakboost::mpl::if_c<
                ...
                Type,
                riakboost::detail::not_a_character_type
            >::type type;
        };
        ...
        template<class CharT, class Traits, class Alloc>
        struct stream_char< ::riakboost::container::basic_string<CharT, Traits, Alloc> >
        {
            typedef CharT type;
        };
        ...
        {
            typedef riakboost::detail::not_a_character_type type;
        };
    ...
    namespace detail // deduce_char_traits template
    {
        ...
        template<class CharT, class Traits, class Alloc, class Source>
        struct deduce_char_traits< CharT
                                 , ::riakboost::container::basic_string<CharT,Traits,Alloc>
                                 , Source
                                 >
        {
            typedef Traits type;
        ...
        template<class CharT, class Traits, class Alloc1, class Alloc2>
        struct deduce_char_traits< CharT
                                 , ::riakboost::container::basic_string<CharT,Traits,Alloc1>
                                 , ::riakboost::container::basic_string<CharT,Traits,Alloc2>
                                 >
        {
            typedef Traits type;
        };
...
# pragma option pop
    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace)
        {
            ...
            if( lc_iequal(begin, lc_nan, lc_NAN, 3) )
            {
                ...
                else value = (riakboost::math::changesign) (std::numeric_limits<T>::quiet_NaN());
                return true;
            } else
            if (( /* 'INF' or 'inf' */
                  end-begin==3
             ...
             )
            {
                ...
                else value = (riakboost::math::changesign) (std::numeric_limits<T>::infinity());
                return true;
            }
                         ...
                         , const CharT* lc_infinity)
        {
            using namespace std;
            const CharT minus = lcast_char_constants<CharT>::minus;
            if ( (riakboost::math::isnan)(value) )
            {
                if ( (riakboost::math::signbit)(value) )
                {
                    *begin = minus;
                    ++ begin;
                }
                ...
                return true;
            } else if ( (riakboost::math::isinf)(value) )
            {
                if ( (riakboost::math::signbit)(value) )
                {
                    *begin = minus;
    ...
    namespace detail // lcast_ret_float
    {
        ...
        {
#if defined(BOOST_HAS_LONG_LONG)
            typedef riakboost::ulong_long_type type;
#elif defined(BOOST_HAS_MS_INT64)
        ...
        inline bool lcast_ret_float(T& value, const CharT* begin, const CharT* end)
        {
            ...
            value = static_cast<T>( has_minus ? (riakboost::math::changesign)(result) : result);

            if ( (riakboost::math::isinf)(value) || (riakboost::math::isnan)(value) ) return false;
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch)
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "riakboost::lexical_cast does not support conversions from wide character to char types."
                    "Use riakboost::locale instead" );
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
                std::locale loc;
            ...
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)),
                    "riakboost::lexical_cast does not support conversions from wide characters to char types."
                    "Use riakboost::locale instead" );
            ...
            bool shl_input_streamable(InputStreamable& input)
            {
                ...
                BOOST_STATIC_ASSERT((riakboost::is_same<char, CharT>::value));
#endif
...
# pragma warning( disable : 4996 )
            ...
            {   using namespace std;
                ...
                end += sprintf(begin,"%.*g", static_cast<int>(riakboost::detail::lcast_get_precision<float>()), val_as_double);
                return end > begin;
            }
            ...
            {   using namespace std;
                ...
                end += sprintf(begin,"%.*g", static_cast<int>(riakboost::detail::lcast_get_precision<double>()), val);
                return end > begin;
            }
            ...
            {   using namespace std;
                ...
                end += sprintf(begin,"%.*Lg", static_cast<int>(riakboost::detail::lcast_get_precision<long double>()), val );
                return end > begin;
            }
#endif
...
# pragma warning( pop )
            ...
            {   using namespace std;
                ...
                const double val_as_double = val;
                                       ...
                                       L"%.*g",
                                       static_cast<int>(riakboost::detail::lcast_get_precision<float >()),
                                       val_as_double );
                return end > begin;
            }
            ...
            {   using namespace std;
                if (put_inf_nan(begin, end, val)) return true;
                                          ...
                                          L"%.*g", static_cast<int>(riakboost::detail::lcast_get_precision<double >()), val );
                return end > begin;
            }
            ...
            {   using namespace std;
                if (put_inf_nan(begin, end, val)) return true;
                                          ...
                                          L"%.*Lg", static_cast<int>(riakboost::detail::lcast_get_precision<long double >()), val );
                return end > begin;
            }
#endif
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(::riakboost::container::basic_string<CharT,Traits,Alloc> const& str)
            {
                start = const_cast<CharT*>(str.data());
                finish = start + str.length();
                return true;
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator<<(riakboost::ulong_long_type n)   { start = lcast_put_unsigned<Traits>(n, finish); return true; }
            bool operator<<(riakboost::long_long_type n)    { return shl_signed(n); }
#elif defined(BOOST_HAS_MS_INT64)
        ...
        // configurations, which do provide std::char_traits<>::eof().
            ...
            inline bool shr_xchar(T& output)
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(CharT) == sizeof(T) ),
                    "riakboost::lexical_cast does not support conversions from wchar_t to char types."
                    "Use riakboost::locale instead" );
...
/************************************ OPERATORS >> ( ... ) ********************************/
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>(riakboost::ulong_long_type& output)     { return shr_unsigned(output); }
            bool operator>>(riakboost::long_long_type& output)      { return shr_signed(output); }
#elif defined(BOOST_HAS_MS_INT64)
            ...
            template<class Alloc>
            bool operator>>(::riakboost::container::basic_string<CharT,Traits,Alloc>& str) { str.assign(start, finish); return true; }
        ...
        public:
            ...
            bool operator>>(double& output)
            {
                ...
                riakboost::mpl::if_c<
                    ...
                    ::riakboost::type_traits::ice_eq< sizeof(double), sizeof(long double) >::value,
#else
                     0
#endif
                    int,
    ...
    namespace detail
    {
        ...
        template<typename CharT, typename Traits, typename Alloc>
        struct is_stdstring< ::riakboost::container::basic_string<CharT, Traits, Alloc> >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };
            ...
            BOOST_STATIC_CONSTANT(bool, value =
               (
                   ::riakboost::type_traits::ice_and<
                           ::riakboost::is_arithmetic<Source>::value,
                           ::riakboost::is_arithmetic<Target>::value,
        ...
        {
            typedef ::riakboost::type_traits::ice_and<
                ::riakboost::is_float<Float>::value,
#if !defined(BOOST_LCAST_NO_WCHAR_T) && !defined(BOOST_NO_SWPRINTF) && !defined(__MINGW32__)
                ::riakboost::type_traits::ice_or<
                    ::riakboost::type_traits::ice_eq<sizeof(Char), sizeof(char) >::value,
                    ::riakboost::is_same<Char, wchar_t>::value
                >::value
#else
                ::riakboost::type_traits::ice_eq<sizeof(Char), sizeof(char) >::value
#endif
        ...
        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_stdstring< ::riakboost::container::basic_string<CharT, Traits, Alloc>, CharT* >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };

        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_stdstring< ::riakboost::container::basic_string<CharT, Traits, Alloc>, const CharT* >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };
...
# pragma warning( disable : 4267 ) // conversion from 'size_t' to 'unsigned int'
        ...
        struct lexical_cast_do_cast
        {
            static inline Target lexical_cast_impl(const Source& arg)
            {
...
#if !defined(BOOST_NO_CHAR16_T) && defined(BOOST_NO_UNICODE_LITERALS)
                BOOST_STATIC_ASSERT_MSG(( !::riakboost::is_same<char16_t, src_char_type>::value
                                          && !::riakboost::is_same<char16_t, target_char_t>::value),
                    "Your compiler does not have full support for char16_t" );
#endif
#if !defined(BOOST_NO_CHAR32_T) && defined(BOOST_NO_UNICODE_LITERALS)
                BOOST_STATIC_ASSERT_MSG(( !::riakboost::is_same<char32_t, src_char_type>::value
                                          && !::riakboost::is_same<char32_t, target_char_t>::value),
                ...
                typedef BOOST_DEDUCED_TYPENAME ::riakboost::detail::deduce_char_traits<
                    char_type, Target, Source
                >::type traits;

                typedef ::riakboost::type_traits::ice_and<
                    ::riakboost::detail::is_char_or_wchar<src_char_type>::value,                    // source is lexical type
                    ::riakboost::detail::is_char_or_wchar<target_char_t>::value,                    // target is a lexical type
                    ::riakboost::is_same<char, src_char_type>::value,                               // source is not a wide character based type
                    ::riakboost::type_traits::ice_ne<sizeof(char), sizeof(target_char_t) >::value   // target type is based on wide character
                >   is_string_widening_required_t;

                typedef ::riakboost::type_traits::ice_or<
                    ::riakboost::is_integral<src>::value,
                    ::riakboost::detail::is_this_float_conversion_optimized<src, char_type >::value,
                    ::riakboost::detail::is_char_or_wchar<src_char_type >::value
                >   is_source_input_optimized_t;

                // If we have an optimized conversion for
                // Source, we do not need to construct stringbuf.
                const bool requires_stringbuf = ::riakboost::type_traits::ice_or<
                        is_string_widening_required_t::value,
                        ::riakboost::type_traits::ice_not< is_source_input_optimized_t::value >::value
                >::value;
...
# pragma warning( pop )
        ...
        {
         typedef riakboost::numeric::Trunc<Source> Rounder;
         typedef Source source_type ;

         typedef BOOST_DEDUCED_TYPENAME mpl::if_<
            ::riakboost::is_arithmetic<Source>, Source, Source const&
          >::type argument_type ;
        ...
        {
          void operator() ( riakboost::numeric::range_check_result r )
          {
            if (r != riakboost::numeric::cInRange)
                BOOST_LCAST_THROW_BAD_CAST(Source, Target);
          }
        } ;
        ...
        struct lexical_cast_dynamic_num_not_ignoring_minus
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                return riakboost::numeric::converter<
                        Target,
                        Source,
            ...
            static inline Target lexical_cast_impl(const Source &arg)
            {
                typedef BOOST_DEDUCED_TYPENAME ::riakboost::mpl::if_c<
                    ::riakboost::type_traits::ice_and<
                        ...
                        >::value,
                        ::riakboost::type_traits::ice_not<
                            ::riakboost::is_same<Source, bool>::value
                        >::value,
                        ::riakboost::type_traits::ice_not<
                            ::riakboost::is_same<Target, bool>::value
                        >::value,
    ...
    {
        typedef BOOST_DEDUCED_TYPENAME ::riakboost::detail::array_to_pointer_decay<Source>::type src;

        typedef BOOST_DEDUCED_TYPENAME ::riakboost::type_traits::ice_or<
                ::riakboost::detail::is_xchar_to_xchar<Target, src >::value,
                ::riakboost::detail::is_char_array_to_stdstring<Target, src >::value,
                ::riakboost::type_traits::ice_and<
                     ::riakboost::is_same<Target, src >::value,
                     ::riakboost::detail::is_stdstring<Target >::value
                >::value
        > shall_we_copy_t;

        typedef BOOST_DEDUCED_TYPENAME
                ::riakboost::detail::is_arithmetic_and_not_xchars<Target, src > shall_we_copy_with_dynamic_check_t;

        typedef BOOST_DEDUCED_TYPENAME ::riakboost::mpl::if_c<
            shall_we_copy_t::value,
            ::riakboost::detail::lexical_cast_copy<src >,
            BOOST_DEDUCED_TYPENAME ::riakboost::mpl::if_c<
                 shall_we_copy_with_dynamic_check_t::value,
                 ::riakboost::detail::lexical_cast_dynamic_num<Target, src >,
                 ::riakboost::detail::lexical_cast_do_cast<Target, src >
            >::type
        >::type caster_type;
